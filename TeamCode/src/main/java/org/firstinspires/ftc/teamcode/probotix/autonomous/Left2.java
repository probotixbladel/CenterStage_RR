...
@Autonomous(name="Left2", group="probotix")
public class Left2 extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        ...
        /*Trajectory delConeBW = drive.trajectoryBuilder(delConeFW2.end())
                ...
                .build();
*/
        Trajectory park1 = drive.trajectoryBuilder(delConeFW3.end().plus(new Pose2d(0,0, Math.toRadians(0))))
        ...
        Trajectory park3 = drive.trajectoryBuilder(delConeFW3.end().plus(new Pose2d(0,0, Math.toRadians(0))))
